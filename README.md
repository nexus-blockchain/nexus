...
Nexus 是一个基于 [Polkadot SDK (Substrate)](https://github.com/nicories/polkadot-sdk) 构建的 Layer-1 区块链，为 Web3 商业场景提供完整的链上基础设施——涵盖商业实体管理、P2P 交易、佣金分销、争议仲裁、去中心化广告、TEE 社群机器人（GroupRobot）及 IPFS 存储。
