...
impl ComplaintType {
    pub fn domain(&self) -> [u8; 8] {
        match self {
            Self::EntityOrderNotDeliver
            | Self::EntityOrderFalseClaim
            | Self::EntityOrderFraud
            | Self::EntityOrderQuality => domains::ENTITY_ORDER,

            Self::OtcSellerNotDeliver
            | Self::OtcBuyerFalseClaim
            | Self::OtcTradeFraud
            | Self::OtcPriceDispute => domains::OTC_ORDER,

            Self::MakerCreditDefault | Self::MakerMaliciousOperation | Self::MakerFalseQuote => {
                domains::MAKER
            }

            Self::NftSellerNotDeliver
            | Self::NftCounterfeit
            | Self::NftTradeFraud
            | Self::NftAuctionDispute => domains::NFT_TRADE,

            Self::SwapMakerNotComplete | Self::SwapVerificationTimeout | Self::SwapFraud => {
                domains::SWAP
            }

            Self::MemberBenefitNotProvided | Self::MemberServiceQuality => domains::MEMBER,

            Self::AdsReceiptDispute | Self::AdsFraudClick | Self::AdsSettlementDispute => {
                domains::ADS
            }
