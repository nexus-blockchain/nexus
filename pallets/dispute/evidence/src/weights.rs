...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    ...
    fn register_public_key() -> Weight {
        Weight::from_parts(40_000_000, 4_000).saturating_add(T::DbWeight::get().writes(1_u64))
    }
    fn store_private_content() -> Weight {
...
impl WeightInfo for () {
    ...
    fn register_public_key() -> Weight {
        Weight::from_parts(40_000_000, 4_000).saturating_add(RocksDbWeight::get().writes(1_u64))
    }
    fn store_private_content() -> Weight {
        Weight::from_parts(80_000_000, 6_000)
            .saturating_add(RocksDbWeight::get().reads(5_u64))
