...
pub use pallet_crypto_common::{
    ContentStatus, EncryptionMethod, KeyManager, KeyType, PrivateContentManager,
...
// ── 用户公钥存储 ──
pub type UserPublicKey<T> =
    pallet_crypto_common::UserPublicKey<BlockNumberFor<T>, <T as Config>::MaxKeyLen>;
