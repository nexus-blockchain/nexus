...
fn make_tiers<T: Config>(
    count: u32,
) -> BoundedVec<TeamPerformanceTier<BalanceOf<T>>, T::MaxTeamTiers> {
...
mod benches {
    ...
    fn update_team_performance_params() {
        ...
        _(
            ...
            Some(5u8),
            Some(true),
            Some(SalesThresholdMode::UpgradeEligibleSpent),
        );
