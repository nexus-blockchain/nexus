...
fn seed_segments<T: Config>(entity_id: u64, segment_count: u32) {
    ...
    for seg_id in 0..segment_count {
        ...
        seg.try_push(account.clone())
            .expect("segment should accept first element");
...
mod benches {
    ...
    fn set_level_based_levels() {
        ...
        #[block]
        {
            ...
            Pallet::<T>::deposit_event(Event::LevelBasedLevelsUpdated {
                entity_id,
                level_id,
            });
        }
    ...
    fn remove_level_based_levels() {
        ...
        #[block]
        {
            ...
            Pallet::<T>::deposit_event(Event::LevelBasedLevelsRemoved {
                entity_id,
                level_id: 1u8,
            });
        }
    ...
    fn schedule_config_change() {
        ...
        #[block]
        {
            ...
            Pallet::<T>::deposit_event(Event::ConfigChangeScheduled {
                entity_id,
                apply_after,
            });
        }
