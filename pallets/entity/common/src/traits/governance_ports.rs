...
use crate::PoolRewardLevelClaimRule;
use alloc::vec::Vec;
...
impl<Balance> MarketGovernancePort<Balance> for () {
    fn governance_set_market_config(_: u64, _: Balance, _: u32) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
    fn governance_pause_market(_: u64) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
    fn governance_resume_market(_: u64) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
    fn governance_close_market(_: u64) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
    fn governance_set_price_protection(
        _: u64,
    ...
    fn governance_set_market_kyc(_: u64, _: u8) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
    fn governance_lift_circuit_breaker(_: u64) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
}
...
pub trait CommissionGovernancePort<Balance> {
    ...
    /// 设置推荐人免除阈值（全局，多级分销层数超过阈值的 Entity 推荐人不获得招商提成）
...
impl<Balance> CommissionGovernancePort<Balance> for () {
    ...
    fn governance_set_referrer_guard(_: u64, _: Balance, _: u32) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
    fn governance_set_commission_cap(_: u64, _: Balance, _: Balance) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
    ...
    fn governance_clear_pool_reward_config(_: u64) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
    fn governance_set_pool_reward_token_enabled(_: u64, _: bool) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
...
impl SingleLineGovernancePort for () {
    ...
    fn governance_pause_single_line(_: u64) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
    fn governance_resume_single_line(_: u64) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
}

/// KYC 治理执行接口
pub trait KycGovernancePort<AccountId> {
    /// 设置 KYC 等级要求
...
impl<AccountId> KycGovernancePort<AccountId> for () {
    fn governance_set_kyc_requirement(_: u64, _: u8, _: bool, _: u32) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
    fn governance_authorize_kyc_provider(_: u64, _: AccountId) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
    fn governance_deauthorize_kyc_provider(_: u64, _: AccountId) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
}
...
impl ShopGovernancePort for () {
    fn governance_set_points_config(_: u64, _: u16, _: u16, _: bool) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
    fn governance_toggle_points(_: u64, _: bool) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
    fn governance_set_shop_policies(_: u64, _: &[u8]) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
}
...
impl<AccountId> TokenGovernancePort<AccountId> for () {
    fn governance_manage_blacklist(_: u64, _: &[u8], _: bool) -> Result<(), DispatchError> {
        Err(DispatchError::Other("not implemented"))
    }
}
