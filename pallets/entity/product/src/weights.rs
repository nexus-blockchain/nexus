...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    ...
    fn batch_publish_products(n: u32) -> Weight {
        Weight::from_parts(
            30_000_000u64.saturating_mul(n as u64),
            5_000u64.saturating_mul(n as u64),
        )
    ...
    fn batch_delete_products(n: u32) -> Weight {
        Weight::from_parts(
            70_000_000u64.saturating_mul(n as u64),
            9_000u64.saturating_mul(n as u64),
        )
...
impl WeightInfo for () {
    ...
    fn batch_publish_products(_n: u32) -> Weight {
        Weight::zero()
    }
    fn batch_unpublish_products(_n: u32) -> Weight {
        Weight::zero()
    }
    fn batch_delete_products(_n: u32) -> Weight {
        Weight::zero()
    }
    fn force_delete_product() -> Weight {
        Weight::zero()
