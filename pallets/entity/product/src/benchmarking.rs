...
fn seed_product<T: Config>(product_id: u64, shop_id: u64, status: ProductStatus) -> T::AccountId {
...
fn seed_products_batch<T: Config>(shop_id: u64, count: u32, status: ProductStatus) -> T::AccountId {
    let owner = funded_account::<T>("owner", 0);
